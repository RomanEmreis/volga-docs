...
Volga предоставляет высокопроизводительную систему ограничения скорости запросов для HTTP API и микросервисов.
...
Volga предоставляет готовые вспомогательные функции в модуле `volga::rate_limiting::by`.
...
Volga предоставляет встроенные экстракторы для типичных ключей партиционирования:
...
Помимо **Token Bucket**, Volga поддерживает ещё три алгоритма:

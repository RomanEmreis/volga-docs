...
## Downloading Files
Volga's [`file!`](https://docs.rs/volga/latest/volga/macro.file.html) macro facilitates file downloads by sending files to clients. This function requires the file name and an opened file stream.
